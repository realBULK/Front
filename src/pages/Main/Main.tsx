...
const Main = () => {
    ...
    const handleMouseDown = (e: React.MouseEvent<HTMLButtonElement>) => {
      setIsDragging(true);
      setOffset({
        x: e.clientX - 55, // 마우스 클릭 위치와 버튼 왼쪽 경계의 차이
      ...
      <div className="fixed bottom-5 w-[393px] bg-[#EDEFFE] justify-center mt-[10%] rounded-t-lg">
        <div className="flex justify-around items-center">
          ...
          <div className="font-[Pretendard] flex flex-col items-center">
            ...
            <button onClick={() => navigate('/record')} className="text-black text-sm">
              내 기록
            </button>
          </div>
          ...
          <div className="font-[Pretendard] flex flex-col items-center">
            ...
            <button onClick={() => navigate('/group')} className="text-black text-sm">
              그룹
            </button>
          </div>
          ...
          <div className="font-[Pretendard] flex flex-col items-center">
            ...
            <button onClick={() => navigate('/home')} className="text-black text-sm">
              홈
            </button>
          </div>
          ...
          <div className="font-[Pretendard] flex flex-col items-center">
            ...
            <button onClick={() => navigate('/diet')} className="text-black text-sm">
              식단
            </button>
          </div>
          ...
          <div className="font-[Pretendard] flex flex-col items-center">
            ...
            <button onClick={() => navigate('/mypage')} className="text-black text-sm">
              내 정보
            </button>
          </div>
        </div>
